/* Phase 5: Scores & Standings Stability
   Lightweight health layer. Does not modify app.js algorithms.
*/
(() => {
  'use strict';
  ...
  function renderScoresHealth() {
    ...
    box.innerHTML = `
      <div class="phase5-title">
        <span>Phase 5 · Scores Health</span>
  ...
  function renderKnockoutHint() {
    ...
    box.innerHTML = `
      <div class="phase5-title"><span>Phase 5 · Knockout Readiness</span><span class="phase5-badge ${ready ? 'good' : 'warn'}">${ready ? 'พร้อมสร้าง Knockout' : 'ยังไม่ควรสร้าง Knockout'}</span></div>
      <div class="phase5-list">
